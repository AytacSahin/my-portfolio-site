import headerImage_00 from '../images/projects/headerImage_00.png'
...
export const projectsDataEn = [
    {
        ...
        description: "This project is a website created for a Hotel. It offers a platform where users can get information about the hotel, contact for reservations and follow updates from social media accounts.",
        methodsofproject: ["React ", "EmailJS", "React Slick"],
        githubLink: "",
        deployLink: "https://www.primusotel.com/"
    },
    {
        id: 1,
        img: headerImage_03,
    ...
    [
        {
            ...
            description: "Bu proje, özel bir Otel için oluşturulmuş resmi bir web sitesidir. Kullanıcıların otel hakkında bilgi alabileceği, rezervasyon için iletişime geçebileceği ve sosyal medya hesaplarından güncellemeleri takip edebileceği bir platform sunar.",
            methodsofproject: ["React ", "EmailJS", "React Slick"],
            githubLink: "",
            deployLink: "https://www.primusotel.com/"
        },
